...
export default function PlacesList() {
  ...
  return <div className="w-0 sm:w-1/2 mx-auto md:m-0 md:w-1/2 h-[100vh] overflow-y-auto sm:p-4 md:border-l">
    <h2 className="text-lg font-semibold mb-4 p-3 sm:p-0">Saved Places</h2>
    <ul className="grid grid-cols-1 md:grid-cols-2 grid-cols-1 gap-4">
