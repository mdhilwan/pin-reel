      ...
      >
        <>
          ...
          <div className="flex mt-2">
            <a
              className="inline-flex items-center gap-2 border border-gray-300 border-e-0 text-gray-700 hover:bg-gray-100 font-medium py-2 px-4 rounded-l-lg transition-colors"
              target="_blank"
            ...
            <a
              className="inline-flex items-center gap-2 border border-gray-300 border-e-0 text-gray-700 hover:bg-gray-100 font-medium py-2 px-4 rounded-none transition-colors"
              target="_blank"
            ...
            <a
              className="inline-flex items-center gap-2 border border-gray-300 text-gray-700 hover:bg-gray-100 font-medium py-2 px-4 rounded-r-lg transition-colors cursor-pointer"
              onClick={() => {
                if (navigator.share) {
                  navigator.share({
